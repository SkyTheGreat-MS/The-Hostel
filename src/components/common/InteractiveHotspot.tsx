        ...
        >
          ...
          >
            ...
            <polygon
              ...
              className="fill-transparent stroke-transparent transition-all duration-300 group-hover:stroke-emerald-400 group-hover:stroke-[0.8] group-hover:[stroke-dasharray:2,2] group-hover:fill-emerald-500/15 group-hover:filter group-hover:drop-shadow-[0_0_8px_rgba(16,185,129,0.4)]"
            />
