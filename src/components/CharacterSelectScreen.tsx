  ...
  return (
    <div className="relative w-full h-full min-h-[620px] flex flex-col justify-between p-4 sm:p-6 md:p-8 bg-[#0a0f0d]/95 backdrop-blur-xl text-[#c2d6cc] overflow-y-auto select-none">
      ...
      <div className="text-center space-y-2 mb-4 sm:mb-6">
        ...
        <h1
          className="text-3xl sm:text-4xl md:text-5xl font-mono font-black text-[#b2c7bd] tracking-widest uppercase drop-shadow-md"
        >
          ANCHOR CONSCIOUSNESS
        </h1>
        <p className="text-xs sm:text-sm text-[#7d998b] max-w-2xl mx-auto font-mono">
          Choose which student&apos;s perspective anchors the investigation. Press keys{' '}
          <span className="text-[#a7c4b5] font-bold">[1-6]</span> or click a card below.
        </p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="mt-2 pt-2 border-t border-[#223028] grid grid-cols-3 gap-1 text-[9px] font-mono text-center">
                <div title="Supernatural Vulnerability" className="bg-[#1a2420] text-[#7d998b] border border-[#26362e] rounded px-1 py-0.5">
                  ⚡{char.multipliers.supernatural_direct}x
                </div>
                <div title="Physical Threat Resistance" className="bg-[#1a2420] text-[#7d998b] border border-[#26362e] rounded px-1 py-0.5">
                  🛡️{char.multipliers.physical_threat}x
                </div>
                <div title="Betrayal Vulnerability" className="bg-[#1a2420] text-[#7d998b] border border-[#26362e] rounded px-1 py-0.5">
